...
public class NaswayModItems {
    //Насвай перенесён в отдельный класс с едой.
    //public static final Item Nasway = LRegisteritem("nasway", new Item(new FabricItemSettings().food(new FoodComponent.Builder().snack().hunger(2).saturationModifier(0.4f).build())));
